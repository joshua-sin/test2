...
class products(db.Model):
  ...
  #colours = db.Column(db.String(), default=False)
  #sizes = db.Column(db.String(), default=False)
  #img = db.Column(db.String(), nullable=False))

def insert_dummy_data(db):
  pd1 = products(name="Shirt", brand='Adidas', description="A shirt", price=100, order_link='https://forms.gle/hY8nHBJJKxxi8QnH6')
